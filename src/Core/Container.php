...
class Container
{
    ...
    {
        $this->singleton(LocalizationInterface::class, fn() => new Localization(
            ConfigInterface::TEXT_DOMAIN
        ));
        $this->singleton(Localization::class, fn() => $this->get(LocalizationInterface::class));
        ...
        $this->singleton(ValidatorInterface::class, fn() => new Validator(
            $this->get(LocalizationInterface::class)
        ));
