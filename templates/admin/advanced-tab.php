...
<form method="post" action="">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="reply_to_email" type="text" id="reply_to_email" value="<?php echo esc_attr($data->replyToEmail); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="reply_to_name" type="text" id="reply_to_name" value="<?php echo esc_attr($data->replyToName); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="force_reply_to" type="checkbox" id="force_reply_to" <?php checked($data->forceReplyTo, 1); ?> value="1">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="cc_email" type="text" id="cc_email" value="<?php echo esc_attr($data->ccEmail); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="cc_name" type="text" id="cc_name" value="<?php echo esc_attr($data->ccName); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="force_cc" type="checkbox" id="force_cc" <?php checked($data->forceCc, 1); ?> value="1">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="bcc_email" type="text" id="bcc_email" value="<?php echo esc_attr($data->bccEmail); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="bcc_name" type="text" id="bcc_name" value="<?php echo esc_attr($data->bccName); ?>" class="regular-text code">
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input name="force_bcc" type="checkbox" id="force_bcc" <?php checked($data->forceBcc, 1); ?> value="1">
                <p class="description">
