...
<form method="post" action="">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <th scope="row">
                <label for="em_smtp_relay_force_reply_to"><?php _e('Force Reply To Address', 'em-smtp-relay');?></label>
            </th>
            <td>
        ...
        <tr valign="top">
            <th scope="row">
                <label for="em_smtp_relay_force_cc"><?php _e('Force Cc Address', 'em-smtp-relay');?></label>
            </th>
            <td>
        ...
        <tr valign="top">
            <th scope="row">
                <label for="em_smtp_relay_force_bcc"><?php _e('Force Bcc Address', 'em-smtp-relay');?></label>
            </th>
            <td>
